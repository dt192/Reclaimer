...
namespace Reclaimer.Blam.Halo5
{
    public class Module
    {
        ...
        /// </remarks>
        /// <param name="globalTagId">The global identifier used to identify the same tag across different modules.</param>
        public ModuleItem GetItemById(int globalTagId) => tagIndex.ItemsById.GetValueOrDefault(globalTagId)?.First();
        ...
        /// </remarks>
        public IEnumerable<ModuleItem> GetLinkedItems() => tagIndex.ItemsById.Values.Select(g => g.First());
